    ...
    function bottomMenu() {
        if(window.innerWidth<578){
            jQuery('.click').on('click', function () {
                jQuery(this).next().stop(true);
                jQuery(this).next().slideToggle('slow');
            })
        }else if(window.innerWidth>=578){
            jQuery('.off').css('display','block');
        }
    }
...
insuranceApp.controller('autoLabel', ['$scope', '$http','$timeout', function ($scope, $http,$timeout) {
    ...
    $http.get(url + '/wp-admin/data.json').success(function (data, status, headers, config) {
        ...
        $scope.preCalculating = function (kbp, k1, k2, k3, k4, k4axa, k5, k6, kbmAxa, kbmUsg, kbmUnica, kbmPzu, kpil) {
            ...
            $scope.preFinalResultUSG = parseFloat(kbp) * parseFloat(k1) * parseFloat(k2) * parseFloat(k3)
                * parseFloat(k4) * parseFloat(k5) * parseFloat(k6) * parseFloat(kbmUsg) * parseFloat(kpil);
            ...
            $scope.preFinalResultUnica = parseFloat(kbp) * parseFloat(k1) * parseFloat(k2) * parseFloat(k3)
                * parseFloat(k4) * parseFloat(k5) * parseFloat(k6) * parseFloat(kbmUnica) * parseFloat(kpil);
            ...
            $scope.preFinalResultPZU = parseFloat(kbp) * parseFloat(k1) * parseFloat(k2) * parseFloat(k3)
                * parseFloat(k4) * parseFloat(k5) * parseFloat(k6) * parseFloat(kbmPzu) * parseFloat(kpil);
    ...
    // Press Key
    $scope.clearActiveTown = function () {
        document.querySelector('.activeTown').classList.remove('activeTown');
    }

    $scope.keyPress = function (event) {
        if(event.keyCode == 40){
            if(!document.querySelector('.activeTown')){
                document.getElementsByClassName('selectForPlugin')[0].children[0].classList.add('activeTown');
            }
            else{
                if(document.querySelector('.activeTown')){
                    var active = document.querySelector('.activeTown');
                    active.nextElementSibling.classList.add('activeTown');
                    active.classList.remove('activeTown');
                }
            }
        }
            ...
            if(!document.querySelector('.activeTown')){
                ...
                if(document.querySelector('.activeTown')){
                    var active = document.querySelector('.activeTown');
                    active.previousElementSibling.classList.add('activeTown');
                    active.classList.remove('activeTown');
                }
            }
        }
            ...
            if(document.querySelector('.activeTown')){
                $timeout(function() {
                    var el = document.querySelector('activeTown');
                    angular.element(el).triggerHandler({type:'mousedown'});
                }, 0);
            }
        }
    }
...
// insuranceApp.directive('keys', function () {
//     return {
//         restrict: 'A',
//         link: function (scope, el, attrs) {
//             $('.town_search').on('keypress', function (evt) {
//
//                    alert(evt.keyCode);
//
//             })
...
//     //     restrict:'A',
//     //     link: function (scope, el, attrs) {
//     //         $('.town_search').on('keypress', function (e) {
//     //
//     //             if(e.keyCode === 38){
